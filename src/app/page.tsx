          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground xs:text-xl/relaxed">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="xs:text-xl/relaxed text-muted-foreground">
                  I worked in {DATA.organizations.length} organizations so far.
                  I have learned so many things which helped me to grow as a
                  software engineer to develop skills and continues
                  improvements.
                </p>
              </div>
            </div>
